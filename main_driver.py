...
if __name__ == '__main__':
    ...
    job_drivers.run_mc_trajectory(
        FILE_DIR, END_TIME, n_traj=1000000, atom_followed="H", init_spe=62, max_tau=0.9)

    # # evaluate path integral-->pathway probability
    job_drivers.evaluate_pathway_probability(
        FILE_DIR, top_n=TOP_N, num=1, flag="", n_traj=10000, atom_followed="H", init_spe=62, max_tau=0.9)
