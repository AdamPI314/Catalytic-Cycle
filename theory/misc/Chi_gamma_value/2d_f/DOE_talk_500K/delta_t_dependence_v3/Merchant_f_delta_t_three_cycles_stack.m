...
%% global propertities
N = 3;
% delta_t_vec = [5.263864487468535e-07, 1.315966121867134e-06, 2.631932243734268e-06, 3.947898365601402e-06, 5.263864487468536e-06, 1.3159661218671339e-05, 2.6319322437342678e-05, 3.9478983656014013e-05, 5.2638644874685356e-05, 0.0001315966121867134, 0.0002631932243734268, 0.00039478983656014016, 0.0005263864487468536, 0.0013159661218671338, 0.0026319322437342676, 0.003947898365601402, 0.005263864487468535, 0.013159661218671338, 0.026319322437342675, 0.039478983656014016, 0.05263864487468535, 0.1315966121867134, 0.2631932243734268, 0.39478983656014016, 0.5263864487468536]
% delta_t_value = 0.0005263864487468536;
% delta_t_value = 0.005263864487468536;
% delta_t_value = 0.05263864487468536;
% delta_t_value = 0.1315966121867134;
% delta_t_value = 0.2631932243734268;
% delta_t_value = 0.39478983656014016;
delta_t_value = 0.5263864487468536;
...
str_name = cell(N,1);
str_name{1, 1} = 'iR cycle';
str_name{2, 1} = 'nR spur cycle';
str_name{3, 1} = 'nR primary cycle';
...
for idx=1:N
    real_idx = N - idx + 1;
    area(time_cell{real_idx, 1} * tau, yvalue_cell{real_idx,1}, 'LineWidth', 2, ...
        'FaceColor', colors(real_idx, :), ...
        'EdgeColor', colors(real_idx, :), 'FaceAlpha', 0.9, 'EdgeAlpha', 0.9);
    hold on;
end
...
%% save to file
figname = strcat('2d_Merchant_f_', end_t, '_three_cycles_stack_', num2str(delta_t_value*tau), '.png');
