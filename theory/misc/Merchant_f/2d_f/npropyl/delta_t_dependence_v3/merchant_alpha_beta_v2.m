...
h1 = plot(time_vec, alpha, ...
    'LineWidth', 2); hold on;
start_idx = 15;
h2 = plot(time_vec(start_idx:end), beta(start_idx:end), ...
    'LineWidth', 2); hold on;
h3 = plot(nan, nan, '-o', 'LineWidth', 2, 'color', 'r');
hold on;
...
leg_h = legend('\alpha', '\beta', 'T');
set(leg_h, 'FontSize', 12, 'Box', 'off');
% set(leg_h, 'Location', 'South')

%% save to file
figname = strcat('merchant_alpha_beta_v2', '.png');
