...
path_idx2 = linspace(3, n_path, n_path-3+1);
...
%% plot
p1 = plot(Y_tmp1, Z_tmp1, 'LineWidth', 2, 'marker', '>'); hold on;
p2 = plot(Y_tmp2, Z_tmp2, 'LineWidth', 2, 'marker', '<'); hold on;
...
text(t_x, t_y, 'npropyl, $t$=0', 'Interpreter','latex', 'FontSize', 20);

%% save to file
figname = strcat('1d_Merchant_f_fix_t0_vary_tf_', end_t, '_S', spe_idx, '_', cycle, '_v5.png');
