...
cycle = 'npropyl_spur_cycle';
path_idx = linspace(1+3, 100, 100-3);
...
% delta_t_vec = [1.2859087486111409e-06, 0.001285908748611141, 0.01285908748611141, 0.03214771871527852, 0.06429543743055705, 0.09644315614583557];
y_label_str = '$\sum_{i=4}^{100}{\chi_{i}^{nR}}$';
title_p = ['$nR$ spur cycle'];
...
fn_2d_f = fullfile(file_dir, ['Merchant_f_2d_S60_HA4_0.9_100000000_10000_100', '.csv']);
