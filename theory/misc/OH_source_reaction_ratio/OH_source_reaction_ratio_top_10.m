...
for idx=1:N
    r_idx = I(idx);
    y_data = (OH_sink_R_mat(:, r_idx)) ./ (R_total);
    H(idx) = semilogy(time_vec, y_data, ...
        'LineWidth', 2); hold on;
end
...
%% save to file
figname = strcat('OH_source_reaction_ratio_top_10', '.png');
