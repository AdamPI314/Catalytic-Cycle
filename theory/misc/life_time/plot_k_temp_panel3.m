...
% plot drc
% CO
p1 = semilogy(time_vec, 1./drc_mat(:, 15), 'LineWidth', 2); hold on;
% C3H6
p2 = semilogy(time_vec, 1./drc_mat(:, 60), 'LineWidth', 2); hold on;
% CH2O
p3 = semilogy(time_vec, 1./drc_mat(:, 18), 'LineWidth', 2); hold on;
% H2O2
p4 = semilogy(time_vec, 1./drc_mat(:, 14), 'LineWidth', 2); hold on;
% acrolein
p5 = semilogy(time_vec, 1./drc_mat(:, 70), 'LineWidth', 2); hold on;
% prod_1
p6 = semilogy(time_vec, 1./drc_mat(:, 95), 'LineWidth', 2); hold on;
% HO2
p7 = semilogy(time_vec, 1./drc_mat(:, 13), 'LineWidth', 2); hold on;
% % vinoxy
% p8 = semilogy(time_vec, 1./drc_mat(:, 47), 'LineWidth', 2); hold on;
...
grid on;
xlim([0, tau*end_t]);
% leg_h = legend([p1; p2; p3; p4; p5; p6; p7; p8],'CO','C_3H_6','CH_2O','H_2O_2','Acrolein','OQ^{\prime}OOH_1', 'HO_2', 'vinoxy');
leg_h = legend([p1; p2; p3; p4; p5; p6; p7],'CO','C_3H_6','CH_2O','H_2O_2','Acrolein','OQ^{\prime}OOH_1', 'HO_2');
set(leg_h, 'FontSize', 14, 'Box', 'off');
set(leg_h, 'Location', 'North')


%% save to file
figname = strcat('drc_panel3', '.png');
