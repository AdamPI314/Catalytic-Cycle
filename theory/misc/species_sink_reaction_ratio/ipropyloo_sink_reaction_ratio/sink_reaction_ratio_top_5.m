...
%% plot
R_idx = [708, 712, 858, 918, 920, 924, 928, 932, 936, 940, 944, 948, 950, 954, 958, 962, 966, 970, 972, 974, 976, 978, 980, 1097, 1104, 1106, 1108];
for idx=1:length(R_idx)
    R_idx(idx) = R_idx(idx) + 1;
end

R_name = {'ipropyloo+C_3H_8 \rightarrow ipropylooh+npropyl', 'ipropyloo+C_3H_8 \rightarrow ipropylooh+ipropyl', 'C_3H_6+ipropyloo \rightarrow allyl+ipropylooh', 'ipropyloo+CH_2O \rightarrow ipropylooh+HCO', 'ipropyloo+acetaldehyde \rightarrow ipropylooh+acetyl', 'ipropyloo+HO_2 \rightarrow ipropylooh+O_2', 'C_2H_4+ipropyloo \rightarrow C_2H_3+ipropylooh', 'CH_3OH+ipropyloo \rightarrow CH_2OH+ipropylooh', 'acrolein+ipropyloo \rightarrow CH_2CHCO+ipropylooh', 'CH_4+ipropyloo \rightarrow CH_3+ipropylooh', 'ipropyloo+CH_3OO \rightarrow ipropyloxy+CH_3O+O_2', 'H_2+ipropyloo \rightarrow H+ipropylooh', 'ipropyloo+C_2H_6 \rightarrow ipropylooh+C_2H_5', 'ipropyloo+propanal \rightarrow ipropylooh+propionyl', 'ipropyloo+acetylperoxy \rightarrow ipropyloxy+acetyloxy+O_2', 'ipropyloo+CH_3CH_2OO \rightarrow ipropyloxy+ethoxy+O_2', 'ipropyloo+ipropyloo \rightarrow O_2+ipropyloxy+ipropyloxy', 'ipropyloo+npropyloo \rightarrow ipropyloxy+npropyloxy+O_2', 'ipropyloo+CH_3 \rightarrow ipropyloxy+CH_3O', 'ipropyloo+C_2H_5 \rightarrow ipropyloxy+ethoxy', 'ipropyloo+ipropyl \rightarrow ipropyloxy+ipropyloxy', 'ipropyloo+npropyl \rightarrow ipropyloxy+npropyloxy', 'ipropyloo+allyl \rightarrow ipropyloxy+allyloxy', 'ipropyloo \rightarrow O_2+ipropyl', 'ipropyloo \rightarrow QOOH_3', 'ipropyloo \rightarrow HO_2+C_3H_6', 'ipropyloo \rightarrow OH+propoxide'};
