...
%% plot
R_idx = [707, 711, 714, 857, 915, 917, 923, 927, 931, 935, 939, 947, 953, 957];
for idx=1:length(R_idx)
    R_idx(idx) = R_idx(idx) + 1;
end

R_name = {'nROOH+nR \rightarrow nROO+C_3H_8', 'nROOH+ipropyl \rightarrow nROO+C_3H_8', 'nROOH \rightarrow nRO+OH', 'allyl+nROOH \rightarrow C_3H_6+nROO', 'nROOH+HCO \rightarrow nROO+CH_2O', 'nROOH+acetyl \rightarrow nROO+acetaldehyde', 'nROOH+O_2 \rightarrow nROO+HO_2', 'C_2H_3+nROOH \rightarrow C_2H_4+nROO', 'CH_2OH+nROOH \rightarrow CH_3OH+nROO', 'CH_2CHCO+nROOH \rightarrow acrolein+nROO', 'CH_3+nROOH \rightarrow CH_4+nROO', 'H+nROOH \rightarrow H_2+nROO', 'nROOH+C_2H_5 \rightarrow nROO+C_2H_6', 'nROOH+propionyl \rightarrow nROO+propanal'};
