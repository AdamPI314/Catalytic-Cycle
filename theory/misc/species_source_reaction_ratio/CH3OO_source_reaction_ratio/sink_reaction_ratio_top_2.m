...
%% plot
R_idx = [132, 135, 137, 139, 141, 143, 145, 147, 149, 151, 153, 321, 327, 341, 395, 421, 491, 497, 561, 563, 565, 609, 641, 663, 689, 767, 769, 851, 877, 911, 913, 943, 945, 1011];
for idx=1:length(R_idx)
    R_idx(idx) = R_idx(idx) + 1;
end

R_name = {'CH_3+O_2(+M) \rightarrow CH_3OO(+M)', 'CH_3OOH+HCO \rightarrow CH_3OO+CH_2O', 'CH_3+CH_3OOH \rightarrow CH_4+CH_3OO', 'CH_2OH+CH_3OOH \rightarrow CH_3OH+CH_3OO', 'CH_3O+CH_3O \rightarrow CH_3OO+CH_3', 'CH_3OOH+O_2 \rightarrow CH_3OO+HO_2', 'CH_2O+CH_3OH+O_2 \rightarrow CH_3OO+CH_3OO', 'O_2+CH_3O+CH_3O \rightarrow CH_3OO+CH_3OO', 'CH_3O+OH \rightarrow CH_3OO+H', 'CH_3O+O_2 \rightarrow CH_3OO+O', 'CH_3OH+O_2 \rightarrow CH_3OO+OH', 'C_2H_5+CH_3OOH \rightarrow C_2H_6+CH_3OO', 'H+CH_3OOH \rightarrow H_2+CH_3OO', 'CH_3O+ethoxy \rightarrow CH_3OO+C_2H_5', 'oxiranyl+CH_3OOH \rightarrow oxirane+CH_3OO', 'CH_3OOH+acetyl \rightarrow CH_3OO+acetaldehyde', 'C_2H_3+CH_3OOH \rightarrow C_2H_4+CH_3OO', 'oxirane+CH_3O \rightarrow C_2H_4+CH_3OO', 'CH_2CH_2OH+CH_3OOH \rightarrow ethanol+CH_3OO', 'CH_3CHOH+CH_3OOH \rightarrow ethanol+CH_3OO', 'ethoxy+CH_3OOH \rightarrow ethanol+CH_3OO', 'propen2oxy+CH_3OOH \rightarrow acetone+CH_3OO', 'CH_2CHCO+CH_3OOH \rightarrow acrolein+CH_3OO', 'propionyl+CH_3OOH \rightarrow propanal+CH_3OO', 'CH_3OCH_2+CH_3OOH \rightarrow CH_3OCH_3+CH_3OO', 'CH_3OOH+npropyl \rightarrow CH_3OO+C_3H_8', 'CH_3OOH+ipropyl \rightarrow CH_3OO+C_3H_8', 'allyl+CH_3OOH \rightarrow C_3H_6+CH_3OO', 'allyloxy+CH_3O \rightarrow allyl+CH_3OO', 'CH_3O+npropyloxy \rightarrow CH_3OO+npropyl', 'CH_3O+ipropyloxy \rightarrow CH_3OO+ipropyl', 'npropyloxy+CH_3O+O_2 \rightarrow npropyloo+CH_3OO', 'ipropyloxy+CH_3O+O_2 \rightarrow ipropyloo+CH_3OO', 'CH_2O+C_2H_3+CH_3OOH \rightarrow propen1ol+CH_3OO'};
...
for idx=1:N
    r_idx = I(idx);
    H(idx) = plot(time_vec, (R_mat(:, r_idx)) ./ (R_total), ...
        'LineWidth', 2); hold on;
end
...
grid on;
xlim([0, tau*end_t]);
leg_h = legend([H(1);H(2)], ...
    R_name{1,I(1)},R_name{1,I(2)});
set(leg_h, 'FontSize', 12, 'Box', 'off');
set(leg_h, 'Location', 'West')


%% save to file
figname = strcat(spe_name, '_source_reaction_ratio_top_2', '.png');
