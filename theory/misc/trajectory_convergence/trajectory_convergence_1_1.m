...
% individual
p1 = semilogy(path_idx(1:delta1:end_idx1), path_p_vec1(1:delta1:end_idx1), ...
    'color',co(1, :), 'LineWidth', 2); hold on;
% cumulative
p2 = semilogy(path_idx(1:delta1:end_idx1), cumu_path_p_vec1(1:delta1:end_idx1) , ...
...
semilogy(path_idx(1:delta2:end_idx2), path_p_vec1(1:delta2:end_idx2), ...
...
zf2_1 = plot([path_idx(1), path_idx(end_idx3)], [const_c1, const_c1], ...
    'marker', 'o', 'color',co(1, :), 'LineWidth', 2); hold on;
% cumulative
zf2_2 = plot(path_idx(1:delta3:end_idx3), cumu_path_p_vec1(1:delta3:end_idx3) , ...
    'marker', 'o', 'color',co(2, :), 'linestyle', '-', 'LineWidth', 2); hold on;
axis tight;
grid on;
% legend
