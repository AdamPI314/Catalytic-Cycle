...
a_x = gca;
t_x = a_x.XLim(1) + 0.250*(a_x.XLim(2) - a_x.XLim(1));
t_y = a_x.YLim(1) + 0.818*(a_x.YLim(2) - a_x.YLim(1));
text(t_x, t_y, [spe_name, '@', 't=stage1A', ', preliminary pathways']);
...
t_x = a_x.XLim(1) + 0.250*(a_x.XLim(2) - a_x.XLim(1));
t_y = a_x.YLim(1) + 0.818*(a_x.YLim(2) - a_x.YLim(1));
text(t_x, t_y, [spe_name, '@', 't=0.5\tau', ', preliminary pathways']);
...
t_x = a_x.XLim(1) + 0.250*(a_x.XLim(2) - a_x.XLim(1));
t_y = a_x.YLim(1) + 0.818*(a_x.YLim(2) - a_x.YLim(1));
text(t_x, t_y, [spe_name, '@', 't=0.5\tau', ', condensed pathways']);
